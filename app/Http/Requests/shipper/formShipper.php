...
class formShipper extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'activite_principale'=>'required',
            'operation_transport'=>'required',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'operation_transport.required' => 'La principale opération est requise',
        ];
    }
}
