                ...
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="avatar-container">
                        <div class="avatar avatar-sm avatar-indicators avatar-online ">
                            <svg  xmlns="http://www.w3.org/2000/svg" width="16" style="font-size: 5em;" height="16" fill="currentColor" class="rounded-circle bi bi-person-circle" viewBox="0 0 16 16">
...
{{--                            <img alt="avatar" src="" class="rounded-circle">--}}
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                    ...
                    <div class="dropdown-item">
                        <a href="{{ route('auth.profile') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <div>
                        <a href="{{ route('auth.logout') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-square"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
