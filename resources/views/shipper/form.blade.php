                                ...
                                <fieldset>1.Immatriculation
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control @error('numero_cnss') is-invalid @enderror" name="numero_cnss" id="numero_cnss" >
                                            @error('numero_cnss')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="date" class="form-control @error('annee_creation') is-invalid @enderror" name="annee_creation" id="annee_creation" >
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control @error('ville') is-invalid @enderror" name="ville" id="ville" required>
                                            @error('ville')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
...
@section('script')
    ...
    <script>
        ...
        $('#btn_add_product_import').click(function (){
            ...
            var input_checkboxes =document.getElementsByName('input[name="input_check_import[]"]:checked');
            ...
            // }
            //
            // console.log(input_checkboxes);

            // input_checkboxes.forEach(check =>{
            //     if(check.checked){
            //         var item = {
            ...
            //     j++;
            // });
            // console.log([data,input_checkboxes]);
            //
            // data = [];
