...
else if(this.value == 'import/export'){
    $('#field_import').show();
    $('#field_export').show();
}
        ...
        var newRow = `
                    <div class="col-md-6">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="hidden" name="product_import[]" class="form-control" id="product_import"  value="${item.id}">
                        </div>
                    </div>`;
        ...
        var newRow = `
                    <div class="col-md-6">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="text" class="form-control" value="${item.libelle}">
                            <input type="hidden" name="product_export[]" class="form-control" id="product_export" value="${item.id}">
                        </div>
                    </div>`;
