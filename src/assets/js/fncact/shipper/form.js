    ...
    var input_checkboxes_export = document.querySelectorAll('#input_check');
    var code_product_export = document.querySelectorAll('#code_product_export');
    var libelle_product_export = document.querySelectorAll('#libelle_product_export');

    for(i = 0; i< input_checkboxes_export.length; i++){
        if(input_checkboxes_export[i].checked){
                var item = {
                'id':input_checkboxes_export[i].value,
                'code':code_product_export[i].textContent,
                'libelle':libelle_product_export[i].textContent,
            };
        ...
        dataExport.forEach(item =>{
            var newRow = `
                    <div class="col-md-6">
                        <label for="validationCustomUsername" class="form-label">Produit ${k}</label>
                        <div class="input-group has-validation">
                                <span class="input-group-text" id="remove_product">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                      <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5Zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5Zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6Z"/>
